...
poi=pd.read_csv("../../Documentos/PronosticosDeportivos/poisson3.csv")
...
gol=pd.read_csv("../../Documentos/PronosticosDeportivos/poisson3.csv")
gol=gol["Unnamed: 8"]
gol=gol.to_numpy()
promedio_de_goles=float(gol[24])
